  ...
  return (
        ...
        <div id='Home' className='mt-7 px-8 md:px-20 items-center flex flex-col md:flex-row w-screen'>
            <div className=''>
                ...
                <h1 className='text-[45px] font-extrabold mb-5 text-orange-500'>Efe Alexander Obieroma</h1>
            ...
            <div>
            <img src="profile1.jpg" className='w-[300px] items-center md:w-[400px] ml-3 rounded-3xl'/>
            </div>
